...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/wandb-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10362&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/wandb-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `wandb` can be installed with:

```
conda install wandb
```

It is possible to list all of the versions of `wandb` available on your platform with:
